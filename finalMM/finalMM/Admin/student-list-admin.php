	...
	<div id="wrapper">
		...
		<main>
            ...
            if ($stmt = $con->prepare($query)) {
                ...
                /*
                echo "<h4>Filer by year:</h4><select id='category1'>";
                echo "<option value='$year'>Freshman</option>";
                echo "<option value='$year'>Sophomore</option>";
                echo "<option value='$year'>Junior</option>";
                echo "<option value='$year'>Senior</option>";
                echo "<h4>Filer by:</h4><select id='category2'>";
